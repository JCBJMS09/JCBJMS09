...
|---|---|---|
| CS104 | Python Scripting | A- |
| IT125 | Introduction to Information Technology | B+ |
| IT255 | Networking Fundamentals | B+ |
| IT210 | Linux Fundamentals | B |
| IT235 | Cloud Server Administration | B- |
| IT143 | Database Design and Analysis | A |
| IT160 | Cloud Computing Essentials | B- |
...
| Category | Details |
|---|---|
| Languages | Python · SQL · Bash (learning) |
| Operating Systems | Linux (Ubuntu/Ubuntu Server) · Windows Server 2022 |
| Networking | Fundamentals · TCP/IP · subnetting concepts |
| Cloud | AWS concepts · Cloud server administration |
| Databases | Relational design · Dimensional modeling · SQL queries |
| Virtualization | Oracle VirtualBox · VM provisioning |
| Security Concepts | Cyber Kill Chain · UFW · AppArmor · system hardening basics |
| Tools | Git (learning) · APT · systemd |
